...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(Context contextExt, List<UserContact> listExt, int layoutExt){
    ...
    private void dialogodel(final UserContact contact){
    ...
    private void dialogoEdit(final UserContact contact){
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        ...
        final ToggleButton genero = viewInflate.findViewById(R.id.gender);
